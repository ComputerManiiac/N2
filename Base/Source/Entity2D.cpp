...
Entity2D::Entity2D(std::string name, Vector3 position, Vector2 rotation, Vector2 scale, ShaderProgram* shader, std::string texturePath) 
 : Entity(name){
	...
	addComponent(contiguous.Allocate<Render2DComponent>(this, shader, texturePath));
