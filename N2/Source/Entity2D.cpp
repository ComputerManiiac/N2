...
Entity2D::Entity2D(std::string name, Vector3 position, float rotation, Vector2 scale, ShaderProgram* shader, std::string texturePath, Vector2 textureOffset) 
 : Entity(name){
	...
	addComponent(contiguous.Allocate<Render2DComponent>(this, shader, texturePath, textureOffset));
