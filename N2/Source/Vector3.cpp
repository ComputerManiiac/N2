...
Vector3 Vector3::Rotate(const float& x, const float& y, const float& z)
{
	Vector3 rotRad;
	rotRad.x = Math::DegreeToRadian(x);
	rotRad.y = Math::DegreeToRadian(y);
	rotRad.z = Math::DegreeToRadian(z);
